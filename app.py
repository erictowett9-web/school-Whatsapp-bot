...
def webhook():
    ...
    reply = next(
        ...
        "Sorry, I did not understand that. You can ask about fees, bus fares, payment details, trips, parental engagement days or ICT programme. For more help call the school office."
    )
